...
namespace GraphProcessor
{
    ...
    public class NodeInspectorObject : SerializedScriptableObject
    {
        ...
        [HideInInspector]public Object previouslySelectedObject;
        
        /// <summary>List of currently selected nodes</summary>
        [LabelText("Selected Nodes"), ListDrawerSettings(Expanded = true, IsReadOnly = true, HideAddButton = true, HideRemoveButton = true)]
        ...
        public virtual void UpdateSelectedNodes(HashSet<BaseNode> nodes)
        {
            selectedNodes = nodes;
        ...
        public virtual void NodeRemoved(BaseNode node)
        {
